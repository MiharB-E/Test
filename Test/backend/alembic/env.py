"""Alembic environment for async SQLAlchemy (aiosqlite / asyncpg).
...
# Replace the sqlalchemy.url with the value from our Settings object so we
# never have to hard-code credentials in alembic.ini.
